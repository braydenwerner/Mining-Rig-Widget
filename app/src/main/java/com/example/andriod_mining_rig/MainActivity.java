...
public class MainActivity extends AppCompatActivity {
    private TextView activeWorkersText;
    private TextView currentHashrateText;
...
//
//
//                activeWorkersText.setText(currentStatsData.getActiveWorkers() + "");
//                currentHashrateText.setText(formatter.format(parsedHashrate) + "");
//            }
//
//            @Override
